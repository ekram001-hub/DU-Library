...
export const SeatBookingModal: React.FC<SeatBookingModalProps> = ({
  ...
  // Default study duration (the duration selector UI was removed; booking always
  // issues a standard session length).
  const targetHours = 4;
    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          {/* Student Info Inputs (NO sample text placeholders) */}
